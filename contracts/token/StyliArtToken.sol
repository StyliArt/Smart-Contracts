...
contract StyliArtToken is Context, IERC20, Ownable {
    ...
    string private _name = "StyliArt Token";
    string private _symbol = "IART";
    ...
    function _transferStandard(address sender, address recipient, uint256 tAmount) private {
        ...
        uint _mFee = rTransferAmount.mul(_marketingFee).div(10**2);
        _rOwned[marketingWallet] = _rOwned[marketingWallet].add(_mFee);
        rTransferAmount = rTransferAmount.sub(_mFee);
